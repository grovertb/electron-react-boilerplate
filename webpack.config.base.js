...
function filterDepWithoutEntryPoints(dep: string): boolean {
  ...
  try {
    ...
    if(fs.existsSync(path.join(__dirname, `node_modules/${dep}/index.js`))) return false
...
export default {
  externals: [ ...Object.keys(externals || {}), ...Object.keys(possibleExternals || {}).filter(filterDepWithoutEntryPoints) ],
